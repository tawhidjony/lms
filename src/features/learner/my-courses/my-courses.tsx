        ...
        {[
          {
            ...
            href: "/course-player?courseId=lc1",
            ...
            actionText: "コースを開く",
            actionHref: "/course-player?courseId=lc1",
            actionClass:
          ...
          },
          {
            ...
            href: "/course-player?courseId=lc2",
            ...
            actionText: "コースを開く",
            actionHref: "/course-player?courseId=lc2",
            actionClass:
              "inline-flex items-center justify-center border border-[#bfdbfe] bg-[#eff6ff] text-blue-600 rounded-lg font-semibold text-xs px-3 py-1.5",
          },
          {
            ...
            href: "/course-player?courseId=lc3",
            desc: "Compliance · Video + Quiz",
            min: "35 min",
            due: "期限 Jul 20",
            progress: 30,
            ...
            actionText: "コースを開く",
            actionHref: "/course-player?courseId=lc3",
            actionClass:
          ...
          },
          {
            ...
            href: "/course-player?courseId=lc7",
            desc: "Compliance · Video + Quiz",
            min: "30 min",
            due: "期限 Aug 05",
            progress: 0,
            ...
            actionText: "受講を開始",
            actionHref: "/course-player?courseId=lc7",
            actionClass:
          ...
          },
          {
            ...
            href: "/course-player?courseId=lc8",
            ...
            progressColor: "bg-slate-300",
            actionText: "受講を開始",
            actionHref: "/course-player?courseId=lc8",
            actionClass:
              "inline-flex items-center justify-center border border-[#cbd5e1] bg-[#f1f5f9] text-slate-600 rounded-lg font-semibold text-xs px-3 py-1.5",
          },
          {
            ...
            actionText: "修了証を表示",
            actionHref: "/certificate?courseId=lc4",
            actionClass:
