...
import { TInput } from "@/components/form/ui-form.types";
import { Button } from "@/components/ui";
import { get, useFormContext } from "react-hook-form";
import { Fragment } from "react/jsx-runtime";
import { schemaLogin } from "./login.component";

export default function LoginView() {
  const {
    formState: { errors },
  } = useFormContext<TInput<typeof schemaLogin>>();
  console.log(errors);
  console.log(get(errors, "email"));
  return (
    <Fragment>
      ...
      <FormInput<TInput<typeof schemaLogin>> name="email" type="email" />
      <label className="block text-xs font-medium text-slate-600 mb-1">
        パスワード
      </label>
